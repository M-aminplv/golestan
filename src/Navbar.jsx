  ...
  return (
		<div className="fixed top-0 w-full  lg:w-[1600px] mx-auto z-50">
			...
			<div className="bg-black min-h-20">
				<GiHamburgerMenu size={40} className=' text-white absolute top-2 right-4 lg:hidden  ' onClick={()=>SetNav(!Nav)}/>
			
					<ul className={Nav || width>=1024?`flex flex-col lg:flex-row lg: gap-5  p-5 pt-10 justify-center`:`hidden`}>
						{navBar.map((item) => {
